    ...
    chapters: [
        {
            ...
            description:
                "An approach to interactive storytelling, where the graphics unfold as the user scrolls through the story, is known as вЂњscrollytellingвЂќ. The scrollytelling template was designed and built to accelerate the process of creating a map-based story. ",
            location: {
